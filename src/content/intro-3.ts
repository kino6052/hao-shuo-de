...
const content: Entry[] = [
  ...
  },
  {
    type: "info",
    title: {
      en: ["Section 1 — Sounds, Words, and Simple Sentences"],
      zh: [],
      ru: [],
    },
    ordered: true,
  ...
  {
    type: "info",
    title: { en: ["Section 2 — Modifying Words and Meaning"], zh: [], ru: [] },
    ordered: true,
    items: [
      {
        text: {
  ...
  },
  {
    type: "info",
    title: {
      en: ["Section 4 — Texts, Vocabulary, and Reference"],
      zh: [],
      ru: [],
    },
    items: [
      {
        text: {
          en: [
            "**Proverbs** — short, memorable lines built from the dictionary.",
          ],
          zh: [],
          ru: [],
        },
      ...
      {
        text: {
          en: ["**Dictionary** — every word, alphabetical and by category."],
          zh: [],
          ru: [],
        },
      },
